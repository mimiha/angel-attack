    ...
    public class LesserDemon : Sprite
    {
        ...
        public void handleCollisions(LinkedList<Sprite> level)
        {
            if (isColliding())
            {
                ...
                CorrectionVector2 smallestCorrectionY = 
                getSmallestCorrectionY(directionY, corrections);
                CorrectionVector2 smallestCorrectionX = 
                getSmallestCorrectionX(directionX, corrections);
